...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        self.context = self.loadContext()
        CrudStore.setContext(context: self.context!)
        Store.populate()
...
extension AppDelegate {
    func loadContext() -> NSManagedObjectContext? {
        guard
            let schemaURL = Bundle.main.url(forResource: "CRUD_Core_Data_Map", withExtension: "momd"),
        ...
        let storageUrl = documentDirectory.appendingPathComponent("mapStore.sqlite")
        print(storageUrl)
